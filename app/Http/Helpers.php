...
class Helper{
            ...
            <!-- <a href="javascript:void(0);">Category<i class="ti-angle-down"></i></a> -->
                ...
                <?php
                    foreach($menu as $cat_info){
                        if($cat_info->child_cat->count()>0){
                            ?>
                            <li><a href="javascript:void(0);"><?php echo $cat_info->title; ?><i class="ti-angle-down"></i></a>
                                <ul class="dropdown  border-0 shadow">
                                    <?php
                                    foreach($cat_info->child_cat as $sub_menu){
                                        ?>
    ...
    public static function getAllProductFromCart($user_id=''){
     ...
     // relationship cart with product
     public static function getAllProductFromCartName($user_id = '')
    {
        if (auth()->check()) {
            if ($user_id == "") $user_id = auth()->user()->id;
            ...
            foreach ($cartItems as $cartItem) {
                $productNames[] = $cartItem->product->title;
            }
    ...
    public static function getAllProductFromCartPhoto($user_id = '')
    {
        if (auth()->check()) {
            if ($user_id == "") $user_id = auth()->user()->id;
