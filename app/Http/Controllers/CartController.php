...
class CartController extends Controller
{
    ...
    public function addToCart(Request $request){
        ...
        if (!auth()->user()){
            ...
            return Redirect::route('login.form')->with('error','Pleanse login with your newly created email and passoword to continue shopping');     
            // return $already_cart;
        }
        ...
        
        {
            ...
            $wishlist=Wishlist::where('user_id',auth()->user()->id)->where('cart_id',null)
    ...
    public function singleAddToCart(Request $request){
       ...
       if (!auth()->user()){
        ...
        return Redirect::route('login')->with('error','Pleanse login with your newly created email and passoword to continue shoping');
    ...
    public function checkout(Request $request){
        ...
        if (!auth()->user()){
            return Redirect::route('login.form')->with('error','Whoops!you cannot checked out empty cart');     
            // return $already_cart;
        }
