											...
											<div class="row">
														...
														<div class="product-img">
															...
															<div class="button-head">
																...
																<div class="product-action-2">
																	<a title="Add to cart" href="{{route('add-to-cart',$product->slug)}}" class="text-success">Add to cart</a>
																</div>
															</div>
														</div>
													</div>
												...
												<div class="col-lg-8 col-md-6 col-12">
													<div class="list-content">
														...
														<a href="{{route('product-detail',$product->slug)}}" class="btn cart text-success" data-id="{{$product->id}}">Buy Now!</a>
													</div>
