      ...
      <form method="post" action="{{route('product.update',$product->id)}}">
        ...
        <div class="form-group">
          ...
          <input type="checkbox" name='is_featured' id='is_featured' value='{{$product->is_featured}}'
           ...
           <input type="radio" id="is_featured" name="is_featured" value="0" required>
           <label for="is_featured_yes">YES</label>
           <input type="radio" id="is_featured" name="is_featured" value="1">
           <label for="is_featured">NO</label>
